...
def test_compare_documents():
    ref_path = Path("D:\\PythonCode\\document_portal\\data\\document_compare\\Long_Report_V1.pdf")
    act_path = Path("D:\\PythonCode\\document_portal\\data\\document_compare\\Long_Report_V2.pdf")
